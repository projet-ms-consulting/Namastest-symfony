...
class QuestionGeneraleCrudController extends AbstractContactCrudController
{
    public const PAGE_NAME = 'Question générale';

    public static function getEntityFqcn(): string
    {
        return QuestionGenerale::class;
    }

    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ->setPageTitle(Crud::PAGE_INDEX, 'Questions générales')
            ->setPageTitle(Crud::PAGE_DETAIL, fn (QuestionGenerale $qg) => self::PAGE_NAME . ' #' . $qg->getId())
            ;
    }
    ...
    ): Response
    {
        ...
        $reponse = new QuestionGeneraleReponse();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try {
                ...
                $reponse->setQuestionGenerale($message);
